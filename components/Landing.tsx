...
const Landing = () => {
  return (
    <div className="scroll-content relative flex min-h-screen w-full justify-center bg-neutral-100 px-4 sm:px-20 dark:bg-neutral-950">
      <div
        aria-hidden
      ...
      <div className="flex w-full max-w-xl min-w-0 flex-col gap-24 md:gap-32">
        <HeroSection />
        <SkillsSection />
        <Experience />
        <DesignsSection />
