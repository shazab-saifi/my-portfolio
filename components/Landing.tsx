...
const Landing = () => {
  return (
    <div className="scroll-content relative flex min-h-screen w-full justify-center bg-neutral-50 px-4 sm:px-20 dark:bg-neutral-950">
      ...
      <div
        aria-hidden
        className="pointer-events-none fixed top-0 left-0 z-20 h-16 w-full bg-linear-to-b from-neutral-950 to-transparent mask-b-from-40% backdrop-blur-[2px] md:h-20"
      />
